...
<cfif structKeyExists(form,"fld_editUserSubmit")>
    <cfset aErrorMessage = application.userService.validateUser(form.fld_userFirstName, form.fld_userLastName,form.fld_userEmail, form.fld_userPassword,form.fld_userPassword)>

    <cfif arrayIsEmpty(aErrorMessage)>
        <cfset
        application.userService.updateUser(
            form.fld_userFirstName,form.fld_userLastName,
            form.fld_userEmail,form.fld_userPassword,
            form.fld_userRole,form.fld_userInstrument,
            form.fld_userComment,0,0, form.fld_userID) />
        ...
        <cfform id="frm_editUser" preservedata="true">
			<fieldset>
				...
				<dl>
					...
					<dd><cfinput name="fld_userEmail" id="fld_userEmail" required="true"  value="#userToEdit.fld_userEmail#" validate="email" message="Please, provide a valid e-mail Address" validateAt="onSubmit" /></dd>
					...
					<dd><cftextarea name="fld_userComment" id="fld_userComment" richtext="true" ><cfoutput >#userToEdit.fld_userComment#</cfoutput></cftextarea></dd>
				</dl>
