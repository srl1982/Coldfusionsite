<cfcomponent Output="false" displayname = "Page Service Component" hint="This component handles various aspects of page management">
    <cffunction name="getPageByID" returntype="query" hint="This function retrieves a single page from the database based on the unique id number of the page">
        ...
        <cfquery  name="rsPage">
            ...
            from TBL_PAGES
            Where FLD_PAGEID = <cfqueryparam value="#arguments.pageID#" cfsqltype="cf_sql_integer"> and FLD_PageIsActive = 1
          </cfquery>
          <cfreturn rsPage/>
    </cffunction>
