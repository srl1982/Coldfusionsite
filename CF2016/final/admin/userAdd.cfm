...
<cfif structKeyExists(form,'fld_addUserSubmit')>
	...
	<cfif ArrayIsEmpty(aErrorMessages)>
		<cfset application.userService.addUser(form.fld_userFirstName,form.fld_userLastName,form.fld_userEmail,form.fld_userPassword,form.fld_userRole,form.fld_userInstrument,form.fld_userComment,1,1) />
		...
		<h1>Create a new user</h1>
			...
			<fieldset>
				...
				<dl>
					...
					<dt>Role</dt>
					<dd>
						<label><cfinput type="radio" name="fld_userRole" id="fld_userRoleAdmin" value="2" />Administrator</label>&nbsp;<label><cfinput type="radio" name="fld_userRole" id="fld_userRoleUser" value="1" checked="true" />User</label>
					</dd>
				...
				<input type="submit" name="fld_addUserSubmit" id="fld_addUserSubmit" value="Add User" />
			</fieldset>
		</cfform>
	</div>
</cf_admin>