<cfcomponent output="false">
	...
	<cffunction name="validateComment" access="public" output="false" returntype="array">
	...
	<cffunction name="getCommentsForNews" access="public" output="false" returntype="query">
		<cfargument name="newsID" type="numeric" required="true" />
